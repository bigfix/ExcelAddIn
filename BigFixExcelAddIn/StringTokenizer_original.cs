...
namespace Ader.Text
{
    ...
    public class StringTokenizer3
    {
        ...
        public StringTokenizer3(TextReader reader)
        {
            if (reader == null)
        ...
        public StringTokenizer3(string data)
        {
            if (data == null)
        ...
        protected Token3 CreateToken(TokenKind3 kind, string value)
        {
            return new Token3(kind, value, line, column);
        }

        protected Token3 CreateToken(TokenKind3 kind)
        {
            string tokenData = data.Substring(savePos, pos - savePos);
            return new Token3(kind, tokenData, saveLine, saveCol);
        }
        ...
        ReadToken:
            ...
            {
                case EOF:
                    return CreateToken(TokenKind3.EOF, string.Empty);
                ...
                case '\r':
                    {
                        ...
                        return CreateToken(TokenKind3.EOL);
                    }
                case '\n':
                    {
                        StartRead();
        ...
        /// </summary>
        /// <returns></returns>
        protected Token3 ReadWhitespace()
        {
            StartRead();
            ...
            return CreateToken(TokenKind3.WhiteSpace);
        ...
        protected Token3 ReadNumber()
        {
            ...
            return CreateToken(TokenKind3.Number);
        }

        /// <summary>
        /// reads word. Word contains any alpha character or _
        /// </summary>
        protected Token3 ReadWord()
        {
            StartRead();
            ...
            return CreateToken(TokenKind3.Word);
        }
        ...
        protected Token3 ReadString()
        {
            ...
            return CreateToken(TokenKind3.QuotedString);
        }
